...
accelerator_list = [TEST_WS_S_TREE,TEST_IS_S_TREE,TEST_OS_S_TREE, TEST_ROS_S_TREE, TEST_RWS_S_TREE, TEST_RIS_S_TREE]
...
for tpc in accelerator_list:
    ...
    area_dict = {'mrr_area':mrr_area,'adc_area':adc_area,'dac_area':dac_area,'rn_area':rn_area,'cache_area':cache_area,'total_area':total_area}
